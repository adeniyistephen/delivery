...
// 	// Validate Product
// 	uniqueTmpTable, err := c.Product_Validation(deliveryDetails, deliveryOption, region_exists.Id, sellerId, dropshipperId)
// 	if err != nil {
// 		if errors.Is(err, database.ErrDBNotFound) {
// 			log.Println(ErrNotFound)
// 		}
...
// func (c Core) Product_Validation(delivery_details string, devOption string, regionId int, sellerId int, dropshipperId int) ([]UniqueTmpTable, error) {
